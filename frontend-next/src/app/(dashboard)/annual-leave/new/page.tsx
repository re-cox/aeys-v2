...
import { CalendarIcon, ArrowLeft, Building2, UserRound } from "lucide-react";
...
import { NewAnnualLeave, LeaveStatus } from "@/types/annualLeave";
...
export default function NewAnnualLeavePage() {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    const loadingToast = toast.loading("Yıllık izin kaydediliyor...");
    
    try {
      const newLeave: NewAnnualLeave = {
      ...
      await createAnnualLeave(newLeave);
      
      toast.dismiss(loadingToast);
      toast.success("Yıllık izin başarıyla kaydedildi.");
      router.push("/annual-leave");
    } catch (error) {
      console.error("Yıllık izin kaydedilirken hata:", error);
      toast.dismiss(loadingToast);
      toast.error("Yıllık izin kaydedilemedi. Lütfen daha sonra tekrar deneyin.");
    } finally {
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6 flex items-center">
        <Button
          ...
          size="sm"
          className="mr-4"
          onClick={() => router.push("/annual-leave")}
        >
          <ArrowLeft className="h-4 w-4 mr-1" />
          Geri
        </Button>
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">
          Yeni Yıllık İzin Kaydı
        </h1>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              <div className="flex items-start gap-2">
                <UserRound className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-medium mb-1">Personel Seçimi</p>
                  <p className="text-gray-600 dark:text-gray-400">
                    İzin kaydı eklemek istediğiniz personeli listeden seçin. Eğer personel listede görünmüyorsa, önce personel kaydı oluşturmanız gerekebilir.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    İzin talepleri varsayılan olarak "Beklemede" durumunda oluşturulur. İzni onaylamak veya reddetmek için durumu değiştirebilirsiniz.
                  </p>
                </div>
              </div>
            </CardContent>
